public class app {
    ...
    public static void main(String[] args) {
        //Variable for search method by player position 
        String quarterback = "QB";
        //Create New Team
        ...
        System.out.print("\nSearch by QB position: ");
        System.out.print(teamOne.getPlayerByPosition(quarterback)); 
        System.out.println("\nTeam Rushing Yards: " + teamOne.getTeamRushYards());
    } 
